...
async def get_beats(
    ...
    for beat in beats_raw:
        beats.append(BeatResponse(
            ...
            audio_url=f"/api/beats/audio/{beat.get('audio_preview_filename') or beat.get('audio_filename', '')}",
            ...
            audio_preview_filename=beat.get("audio_preview_filename"),
            wav_filename=beat.get("wav_filename"),
            stems_filename=beat.get("stems_filename"),
